...
const endBlock = content.substring(content.lastIndexOf('{hasSources && (')); 
...
const newBlock = `{hasSources && (
                ...
                {!isStreaming && (
                  <div className="mt-2 flex opacity-0 transition-opacity group-hover:opacity-100 items-center justify-end gap-2">
                    <button
                      type="button"
                      onClick={handleCopy}
...
content = content.replace(endBlock, newBlock);
